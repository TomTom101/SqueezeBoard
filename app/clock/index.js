...
angular.module('clock', ['common', 'ngAnimate']).controller('ClockController', [
  '$scope', '$filter', '$interval', '$http', 'ClockService', 'ForecastFactory', 'AirsensorFactory', function($scope, $filter, $interval, $http, ClockService, ForecastFactory, AirsensorFactory) {
    var getForecast, getTomorrowData, init, initAirvalueStream, setAirColor, temp_scale, tick;
    ...
    $scope.getTempColor = function(fahrenheit) {
      var celcius, color;
